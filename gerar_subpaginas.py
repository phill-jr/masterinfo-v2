...
{boleto_html}
{extra_scripts}
  <script src="/tracking.js?v=20260824a" defer></script>
...
def page_autor(depth=1):
    ...
    body = ('\n  <main class="blog-main">\n    <div class="article-band">\n      <article class="article">'
            f'\n      <div class="byline"><img src="{a["img"]}" alt="{a["name"]}" class="byline-avatar"><div class="byline-info"><span class="byline-name">{a["name"]}</span><span class="byline-role">{a["role"]}</span><a href="https://www.linkedin.com/in/philipe-alves-85687aa2/" target="_blank" rel="noopener me" class="byline-link" style="display:inline-flex;align-items:center;gap:5px;font-size:0.85rem;font-weight:600;color:var(--orange-dark);margin-top:3px"><i class="ph ph-linkedin-logo"></i> LinkedIn</a></div></div>'
    ...
    person = {"@context": "https://schema.org", "@type": "ProfilePage",
              ...
              "mainEntity": {"@type": "Person", "@id": SITE_URL + "/sobre/philipe/#person",
                             ...
                             "sameAs": ["https://www.linkedin.com/in/philipe-alves-85687aa2/"],
